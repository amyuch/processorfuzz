...
export SPIKE="/home/AM2/chipyard/.conda-env/riscv-tools/bin/spike"
#export NO_GUIDE=1
...
then
	...
	export SPIKE="/home/AM2/prefuzz/processorfuzz/ProcessorFuzz/spike/riscv-isa-sim-all-csr/build/spike"
fi
